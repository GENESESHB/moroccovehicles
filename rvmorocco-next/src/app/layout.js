...
export const metadata = {
  ...
  keywords: [
    ...
    'location de voiture pas cher Maroc',
    'location voiture à partir de 7 euro',
    'louer voiture maroc',
    'gestion parc automobile',
    'digitalisation contrats location',
    'logiciel location voiture',
    'location véhicules Maroc',
    'agence location voiture Maroc',
    'logiciel gestion agence location',
