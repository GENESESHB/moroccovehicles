...
export default function AssuranceBlogSection() {
    return (
        <article className="blog-section" style={{ padding: '60px 20px', maxWidth: '1000px', margin: '0 auto', fontFamily: 'system-ui, sans-serif' }}>
            ...
            <h1 style={{ fontSize: "42px", fontWeight: "800", marginBottom: "32px", color: "#0f172a", lineHeight: "1.2" }}>Comment réduire vos coûts d’assurance de flotte en 2026 - Le super gestionair flotte automobile moins chere</h1>
            ...
            <p style={{ fontSize: '22px', lineHeight: '1.7', color: '#334155', marginBottom: '40px', fontStyle: 'italic', fontWeight: '500' }}>
                Découvrez les stratégies pour optimiser les primes et gérer les sinistres plus efficacement avec un logiciel dédié.
            </p>
            ...
            <div style={{ margin: '0 0 50px 0', borderRadius: '20px', overflow: 'hidden', boxShadow: '0 25px 50px -12px rgba(0,0,0,0.25)', position: 'relative' }}>
                ...
                <img src="/compressed_videos/insurance.png" alt="Scan visuel et verrouillage de la caution" style={{ width: '100%', display: 'block', maxHeight: '600px', objectFit: 'cover', transform: 'scale(1.02)', transition: 'transform 0.5s ease' }} />
            ...
            <script
                ...
                dangerouslySetInnerHTML={{
                    __html: JSON.stringify({
                        ...
                        "@type": "VideoObject",
                        "name": "Démonstration détaillée : gestionair flotte automobile moins chere (ASSURANCE)",
                        "description": "Intelligence Artificielle & Démonstration Complète du module assurance. Dans cette vidéo, nous explorons en temps réel la configuration des assurances. Visualisez comment le gestionair flotte automobile moins chere permet un affichage détaillé pour chaque véhicule de votre parc. Le paramétrage automatise les alertes avant la date d'expiration pour ne jamais rater un renouvellement, garantissant ainsi sécurité financière et couverture juridique optimale. L'idéal incontesté pour acquérir un gestionair flotte automobile moins chere robuste et scalable.",
                        "thumbnailUrl": [
                            "https://www.moroccovehicles.com/compressed_videos/insurance.png"
                        ],
                        "uploadDate": "2026-04-15T08:00:00+01:00",
                        "duration": "PT3M30S",
                        "contentUrl": "https://www.moroccovehicles.com/compressed_videos/MoroccoVehicles - Location sans frais de livraison _ Gestion de parc gratuite - assurance-setup-and-view-for-each-vehicles.mp4",
                        "embedUrl": "https://www.moroccovehicles.com/blogs/assurance-power-gestionair-flotte-automobile-moins-chere"
                    })
                }}
            />
<video width="100%" autoPlay loop muted playsInline poster="/compressed_videos/insurance.png" title="Démonstration logicielle du gestionair flotte automobile moins chere" aria-label="Vidéo démonstrative complète expliquant le fonctionnement exact du module ASSURANCE et ses bénéfices opérationnels" style={{ display: "block", width: "100%", pointerEvents: "none" }}>
                  <source src="/compressed_videos/MoroccoVehicles - Location sans frais de livraison _ Gestion de parc gratuite - assurance-setup-and-view-for-each-vehicles.mp4" type="video/mp4" />
                  Votre navigateur ne supporte pas la balise vidéo.
                Votre navigateur ne supporte pas l'affichage de notre vidéo pour le gestionair flotte automobile moins chere. <br/><strong>Contexte de la vidéo :</strong> Ce clip explique en détail le fonctionnement du module ASSURANCE pour digitaliser votre agence.
</video>
            </div>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(280px, 1fr))', gap: '24px' }}>
                ...
                <div style={{ borderRadius: '16px', overflow: 'hidden', boxShadow: '0 10px 15px -3px rgba(0,0,0,0.1)', background: 'white', border: '1px solid #e2e8f0' }}>
                  <div style={{ position: 'relative', height: '200px' }}>
                    <img src="/compressed_videos/select-part-ondomage-vehicles.png" alt="Screenshot additionnel" style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }} />
                  </div>
                  <div style={{ padding: '16px', borderTop: '1px solid #f1f5f9' }}>
                    <div style={{ color: '#0f172a', fontSize: '14px', fontWeight: '600', lineHeight: '1.4' }}>Détails avancés : assurance</div>
                  </div>
                </div>
                <div style={{ borderRadius: '16px', overflow: 'hidden', boxShadow: '0 10px 15px -3px rgba(0,0,0,0.1)', background: 'white', transition: 'transform 0.3s ease, box-shadow 0.3s ease', cursor: 'pointer' }}  >
                  <div style={{ position: 'relative', height: '200px' }}>
                    <img src="/compressed_videos/part-select-endomage-car-for-lintegre-en-contra.png" alt="Cartographie interactive des dommages carrosserie" style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }} />
                  </div>
                  <div style={{ padding: '16px', borderTop: '1px solid #f1f5f9' }}>
                    <div style={{ color: '#0f172a', fontSize: '14px', fontWeight: '600', lineHeight: '1.4' }}>Cartographie interactive des dommages carrosserie</div>
                  </div>
                </div>
                <div style={{ borderRadius: '16px', overflow: 'hidden', boxShadow: '0 10px 15px -3px rgba(0,0,0,0.1)', background: 'white', transition: 'transform 0.3s ease, box-shadow 0.3s ease', cursor: 'pointer' }}  >
                  <div style={{ position: 'relative', height: '200px' }}>
                ...
                <div style={{ backgroundColor: '#ffffff', border: '1px solid #e2e8f0', borderRadius: '12px', padding: '24px', display: 'flex', gap: '20px', alignItems: 'flex-start' }}>
                    ...
                    <div>
                        ...
                        <p style={{ fontSize: '18px', lineHeight: '1.6', color: '#334155', fontStyle: 'italic', margin: '0 0 16px 0' }}>
                            "Excellent ! J'avais du mal à suivre tous nos sinistres et l'entretien. Ce module est la solution que je cherchais. Fortement recommandé."
                        </p>
                        <div style={{ fontWeight: 'bold', color: '#1e293b' }}>Amina R.</div>
                        <div style={{ fontSize: '14px', color: '#64748b' }}>Propriétaire Flotte 50+</div>
                    </div>
                </div>
            </div>
            ...
            <script
                ...
                dangerouslySetInnerHTML={{
                    __html: JSON.stringify({
                        ...
                        "name": "Module ASSURANCE - gestionair flotte automobile moins chere",
                        ...
                        "review": [
                          {
                            ...
                            "reviewBody": "Gérer les assurances et les cas de sinistres était notre plus grande angoisse. Grâce à ce gestionair flotte automobile moins chere, nous sommes notifiés avant chaque expiration. Un outil 5 étoiles !",
                            "reviewRating": {
                              "@type": "Rating",
                              "bestRating": "5",
                              "ratingValue": "5",
