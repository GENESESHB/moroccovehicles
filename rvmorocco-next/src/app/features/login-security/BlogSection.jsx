...
export default function BlogSectionLoginSecurity() {
    ...
    <article className="blog-section" style={{ padding: '60px 20px', maxWidth: '1000px', margin: '0 auto', fontFamily: 'Inter, system-ui, sans-serif', color: '#1e293b', lineHeight: '1.8' }}>
      ...
      <div style={{ margin: '50px 0', borderRadius: '20px', overflow: 'hidden', background: '#0f172a', position: 'relative', boxShadow: '0 25px 50px -15px rgba(0,0,0,0.25)', border: '1px solid #334155' }}>
        ...
        <video 
          ...
          playsInline 
          controls
          poster="/compressed_videos/login-form.png" 
          title="Demonstration du gestionair flotte automobile moins chere - Module LOGIN-SECURITY" 
          style={{ display: 'block', width: '100%' }}
        >
          <source 
            src="/compressed_videos/moroccovehicles-location-sans-frais-de-livraison-gestion-de-parc-gratuite-login-setup.mp4" 
            type="video/mp4" 
          />
