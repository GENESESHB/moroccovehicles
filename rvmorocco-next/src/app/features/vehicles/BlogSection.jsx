...
export default function VehiclesBlogSection() {
    return (
        <article className="blog-section" style={{ padding: '60px 20px', maxWidth: '1000px', margin: '0 auto', fontFamily: 'system-ui, sans-serif' }}>
            ...
            <h1 style={{ fontSize: "42px", fontWeight: "800", marginBottom: "32px", color: "#0f172a", lineHeight: "1.2" }}>Optimisation du cycle de vie des véhicules commerciaux - Le super gestionair flotte automobile moins chere</h1>
            ...
            <p style={{ fontSize: '22px', lineHeight: '1.7', color: '#334155', marginBottom: '40px', fontStyle: 'italic', fontWeight: '500' }}>
                De l’achat à la revente : comment maximiser la rentabilité de chaque voiture de votre parc.
            </p>
            ...
            <div style={{ margin: '0 0 50px 0', borderRadius: '20px', overflow: 'hidden', boxShadow: '0 25px 50px -12px rgba(0,0,0,0.25)', position: 'relative' }}>
                ...
                <img src="/compressed_videos/add-vehicle-form-and-list-management-status-cars.png" alt="Fiche technique interactive et statut du parc" style={{ width: '100%', display: 'block', maxHeight: '600px', objectFit: 'cover', transform: 'scale(1.02)', transition: 'transform 0.5s ease' }} />
            ...
            <script
                ...
                dangerouslySetInnerHTML={{
                    __html: JSON.stringify({
                        ...
                        "@type": "VideoObject",
                        "name": "Démonstration détaillée : gestionair flotte automobile moins chere (VEHICLES)",
                        "description": "Intelligence Artificielle & Démonstration Complète du module vehicles. Démonstration des fonctionnalités d'édition du parc roulant : ajouter, retirer, suspendre, activer ou désactiver un véhicule. Regardez comment le gestionair flotte automobile moins chere enregistre les plaques d'immatriculation, marques, modèles, catégories et kilométrages initiaux pour maintenir un inventaire fiable à la seconde près, qu'il s'agisse de gammes économiques ou de SUV de luxe. L'idéal incontesté pour acquérir un gestionair flotte automobile moins chere robuste et scalable.",
                        "thumbnailUrl": [
                            "https://www.moroccovehicles.com/compressed_videos/add-vehicle-form-and-list-management-status-cars.png"
                        ],
                        "uploadDate": "2026-04-15T08:00:00+01:00",
                        "duration": "PT3M30S",
                        "contentUrl": "https://www.moroccovehicles.com/compressed_videos/MoroccoVehicles - Location sans frais de livraison _ Gestion de parc gratuite - vehicles-components-add-delet-update-vehicles-and-active-or-desactive.mp4",
                        "embedUrl": "https://www.moroccovehicles.com/blogs/vehicles-power-gestionair-flotte-automobile-moins-chere"
                    })
                }}
            />
<div dangerouslySetInnerHTML={{ __html: `<video width="100%" autoplay loop muted playsinline poster="/compressed_videos/add-vehicle-form-and-list-management-status-cars.png" title="Démonstration logicielle du gestionair flotte automobile moins chere" aria-label="Vidéo démonstrative complète expliquant le fonctionnement exact du module VEHICLES et ses bénéfices opérationnels" style="display: block; width: 100%; pointer-events: none;">
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(280px, 1fr))', gap: '24px' }}>
                <div style={{ borderRadius: '16px', overflow: 'hidden', boxShadow: '0 10px 15px -3px rgba(0,0,0,0.1)', background: 'white', transition: 'transform 0.3s ease, box-shadow 0.3s ease', cursor: 'pointer' }}  >
                  <div style={{ position: 'relative', height: '200px' }}>
                    <img src="/compressed_videos/add-cars-form.png" alt="Intégration accélérée d'un nouveau véhicule" style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }} />
                  </div>
                  <div style={{ padding: '16px', borderTop: '1px solid #f1f5f9' }}>
                    <div style={{ color: '#0f172a', fontSize: '14px', fontWeight: '600', lineHeight: '1.4' }}>Intégration accélérée d'un nouveau véhicule</div>
                  </div>
                </div>
                <div style={{ borderRadius: '16px', overflow: 'hidden', boxShadow: '0 10px 15px -3px rgba(0,0,0,0.1)', background: 'white', transition: 'transform 0.3s ease, box-shadow 0.3s ease', cursor: 'pointer' }}  >
                  <div style={{ position: 'relative', height: '200px' }}>
            ...
            <script
                ...
                dangerouslySetInnerHTML={{
                    __html: JSON.stringify({
                        ...
                        "name": "Module VEHICLES - gestionair flotte automobile moins chere",
                        ...
                        "review": [
                          {
                            ...
                            "reviewBody": "L'enregistrement d'une nouvelle voiture et de son kilométrage initial prend 30 secondes. La simplicité est vraiment le gros point fort de ce gestionnaire.",
                            "reviewRating": {
                              "@type": "Rating",
                              "bestRating": "5",
                              "ratingValue": "5",
