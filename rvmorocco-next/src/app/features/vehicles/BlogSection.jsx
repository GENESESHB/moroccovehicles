...
export default function BlogSection() {
  ...
  const videoFileName = "moroccovehicles-location-sans-frais-de-livraison-gestion-de-parc-gratuite-google-chrome-2026-04-14-18-44-35.mp4";
  const videoSrc = `/compressed_videos/${videoFileName}`;
  const posterSrc = "/compressed_videos/add-vehicle-form-and-list-management-status-cars.png";
    ...
    <article className="blog-section" style={{ padding: '60px 20px', maxWidth: '1000px', margin: '0 auto', fontFamily: 'Inter, system-ui, sans-serif', color: '#1e293b', lineHeight: '1.8' }}>
      ...
      <div style={{ margin: '50px 0', borderRadius: '20px', overflow: 'hidden', background: '#0f172a', position: 'relative', boxShadow: '0 25px 50px -15px rgba(0,0,0,0.25)', border: '1px solid #334155' }}>
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              description: 'Demonstration complete du fonctionnement du module VEHICLES dans notre gestionair flotte automobile moins chere.',
              thumbnailUrl: [`https://www.moroccovehicles.com${posterSrc}`],
        ...
        <video 
          ...
          controls
          poster={posterSrc}
          title="Demonstration du gestionair flotte automobile moins chere - Module VEHICLES" 
          style={{ display: 'block', width: '100%', minHeight: '240px', backgroundColor: '#000' }}
          onError={(e) => {
            console.error("Erreur de chargement de la vidéo : vérifiez le fichier dans /public/compressed_videos/", e);
          }}
        >
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            image: [`https://www.moroccovehicles.com${posterSrc}`],
