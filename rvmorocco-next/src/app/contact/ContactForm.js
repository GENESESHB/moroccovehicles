...
export default function ContactForm() {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      color: '#1976d2',
      href: 'mailto:contact@moroccovehicles.com'
    },
    {
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div className={styles['contact-grid']}>
            <div className={styles['contact-info-side']}>
              ...
              <div className={styles['social-section']}>
                ...
                <div className={styles['social-links']}>
                  <a 
                    href="https://www.linkedin.com/in/morocco-vehicles/" 
                    target="_blank"
                  ...
                  <a 
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className={`${styles['social-btn']} ${styles.whatsapp}`}
                    aria-label="WhatsApp"
                  >
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
              ...
              <div className={styles['map-container']}>
                <iframe 
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d106376.56000758978!2d-7.66939495!3d33.5722872!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xda7cd4778aa113b%3A0xb06c1d84f310fd13!2sCasablanca%2C%20Morocco!5e0!3m2!1sen!2sus!4v1700000000000!5m2!1sen!2sus"
                  width="100%" 
                  height="100%" 
            ...
            <div className={styles['contact-form-side']}>
              <div className={styles['form-container']}>
                ...
                {status === 'SUCCESS' && (
                  <div className={`${styles['status-message']} ${styles.success}`} role="alert">
                    ...
                    <div>
                      ...
                      <span>Nous vous répondrons sous 24h.</span>
                    </div>
                  </div>
                )}
                
                {status === 'ERROR' && (
                  <div className={`${styles['status-message']} ${styles.error}`} role="alert">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                    ...
                    <div>
                      ...
                      <span>Veuillez réessayer ou nous contacter directement.</span>
                    </div>
                  </div>
                )}
                ...
                <form onSubmit={handleSubmit} className={styles['contact-form']} noValidate>
                  <div className={styles['form-row']}>
                    <div className={`${styles['form-group']} ${focusedField === 'name' ? styles.focused : ''} ${touched.name && !formData.name ? styles.error : ''}`}>
                      <label htmlFor="name">
                        Nom complet <span aria-label="required">*</span>
                      </label>
                      <input
                        type="text"
                        id="name"
                    ...
                    <div className={`${styles['form-group']} ${focusedField === 'email' ? styles.focused : ''} ${touched.email && !formData.email.includes('@') ? styles.error : ''}`}>
                      <label htmlFor="email">
                        Email professionnel <span aria-label="required">*</span>
                      </label>
                      <input
                        type="email"
                        id="email"
                  ...
                  <div className={`${styles['form-group']} ${focusedField === 'subject' ? styles.focused : ''} ${touched.subject && !formData.subject ? styles.error : ''}`}>
                    <label htmlFor="subject">
                      Sujet <span aria-label="required">*</span>
                    </label>
                  ...
                  <div className={`${styles['form-group']} ${focusedField === 'message' ? styles.focused : ''} ${touched.message && !formData.message ? styles.error : ''}`}>
                    <label htmlFor="message">
                      Votre message <span aria-label="required">*</span>
                    </label>
                    <textarea
                      id="message"
                      name="message"
                  ...
                  <div className={styles['form-footer']}>
                    <label className={styles['checkbox-container']}>
                      ...
                      <span className={styles['checkbox-label']}>
                        J'accepte que mes données soient traitées conformément à la <a href="/privacy" target="_blank">politique de confidentialité</a> <span aria-label="required">*</span>
                      </span>
                    </label>
      ...
      <section className={styles['faq-section']}>
        <div className={styles.container}>
          <div className={styles['faq-box']}>
            ...
            <a href="/faq" className={styles['btn-outline']}>Voir la FAQ</a>
          </div>
        </div>
      </section>
    </div>
